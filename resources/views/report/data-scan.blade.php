...
@section('content')
    <ol class="breadcrumb float-xl-end">
        ...
        <li class="breadcrumb-item"><a href="javascript:;">Data Scan</a></li>
        <li class="breadcrumb-item active">index</li>
    </ol>

    <h1 class="page-header">Scan <small>data Per hari</small></h1>
    ...
    <div class="tab-content bg-white p-3 rounded-bottom" id="myTabContent">
        <x-form-search action="#" method="" excel="{{route('inventory.download-excel')}}" pdf="{{route('download-pdf')}}"/>
        {{-- panel table IN --}}
